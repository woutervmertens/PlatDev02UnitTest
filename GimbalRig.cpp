...
void GimbalRig::Initialize(GameContext* pContext)
{
		m_pBase = new CylinderPosColorNorm(8,40,0.5,(XMFLOAT4)Colors::DarkGray);
		m_pPillar0 = new CylinderPosColorNorm(0.5f,10,15,(XMFLOAT4)Colors::LightGray);
		m_pPillar0->Translate(-6.5f, 7.5f, 0.f);
		m_pPillar1 = new CylinderPosColorNorm(0.5f,10,15,(XMFLOAT4)Colors::LightGray);
		m_pPillar1->Translate(6.5f,7.5f,0.f);
		
		m_pOuterTorus = new TorusPosColorNorm(5.75f,30,0.25f,10,(XMFLOAT4)Colors::Red);
		m_pOuterTorus->Translate(0.f,15.f,0.f);
		m_pMiddleTorus = new TorusPosColorNorm(5.25f,30,0.25f,10,(XMFLOAT4)Colors::Green);
		m_pInnerTorus = new TorusPosColorNorm(4.75f,30,0.25f,10,(XMFLOAT4)Colors::Blue);
...
void GimbalRig::Update(GameContext* pContext)
{
...
void GimbalRig::Draw(GameContext* pContext)
{
